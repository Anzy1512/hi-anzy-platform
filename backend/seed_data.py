...
NETWORK_RESOURCES = [
    ...
    # Media
    {"name": "National Print & Digital Powerhouses", "slug": "national-print-digital-powerhouses", "category": "Media", "relationshipType": "NETWORK ACCESS", "geography": "India", "capabilities": ["The Hindu", "The Times of India", "The Indian Express", "Hindustan Times", "The Tribune", "Firstpost", "The Print"], "featured": False, "publicStatus": "public", "lastVerified": "2025-Q4", "portfolioUrl": None, "note": "Placement access via media partners. Not an endorsement."},
    {"name": "Broadcast & Digital News Networks", "slug": "broadcast-digital-news-networks", "category": "Media", "relationshipType": "NETWORK ACCESS", "geography": "India", "capabilities": ["Aaj Tak", "NDTV Network", "ABP Network", "Zee Network", "Star Network", "Network18", "HT Media"], "featured": False, "publicStatus": "public", "lastVerified": "2025-Q4", "portfolioUrl": None, "note": "Placement access via media partners. Not an endorsement."},
    {"name": "Entertainment & Lifestyle Portals", "slug": "entertainment-lifestyle-portals", "category": "Media", "relationshipType": "NETWORK ACCESS", "geography": "India", "capabilities": ["Bollywood Hungama", "Zoom TV", "The Quint", "RVCJ", "Midday", "Boldsky"], "featured": False, "publicStatus": "public", "lastVerified": "2025-Q4", "portfolioUrl": None, "note": "Placement access via media partners."},
    {"name": "International Business Press", "slug": "international-business-press", "category": "Media", "relationshipType": "NETWORK ACCESS", "geography": "International", "capabilities": ["Yahoo Finance", "Benzinga", "IB Times", "Gulf News", "Khaleej Times"], "featured": False, "publicStatus": "public", "lastVerified": "2025-Q4", "portfolioUrl": None, "note": "Placement access via international desks."},
    {"name": "Tech, Auto & Sports Desks", "slug": "tech-auto-sports-desks", "category": "Media", "relationshipType": "NETWORK ACCESS", "geography": "India", "capabilities": ["HT Tech", "Gizbot", "Techcircle", "Times Drive", "NDTV Sports", "Cricket Country"], "featured": False, "publicStatus": "public", "lastVerified": "2025-Q4", "portfolioUrl": None, "note": "Vertical-desk placement access."},
    # Venues & Events
    {"name": "Premium Hotels & Hospitality", "slug": "premium-hotels-hospitality", "category": "Venues", "relationshipType": "NETWORK ACCESS", "geography": "India", "capabilities": ["The Oberoi", "ITC Maurya", "The Leela Palace", "Shangri-La", "The Ashok"], "featured": False, "publicStatus": "public", "lastVerified": "2025-Q3", "portfolioUrl": None, "note": "Venue partnership access for launches and experiences."},
    {"name": "Clubs & Nightlife Circuit", "slug": "clubs-nightlife-circuit", "category": "Venues", "relationshipType": "NETWORK ACCESS", "geography": "Delhi NCR+", "capabilities": ["Soho", "Diablo", "Aquila", "MNKY HOUZ", "Summer House", "SOCIAL"], "featured": False, "publicStatus": "public", "lastVerified": "2025-Q3", "portfolioUrl": None, "note": "Activation access across nightlife properties."},
    {"name": "Stadiums & Auditoriums", "slug": "stadiums-auditoriums", "category": "Venues", "relationshipType": "NETWORK ACCESS", "geography": "India", "capabilities": ["JLN Stadium", "Arun Jaitley Stadium", "The Stein Auditorium", "India Habitat Centre"], "featured": False, "publicStatus": "public", "lastVerified": "2025-Q3", "portfolioUrl": None, "note": "Large-format venue access."},
    {"name": "Festivals & Cultural Properties", "slug": "festivals-cultural-properties", "category": "Events", "relationshipType": "NETWORK ACCESS", "geography": "India", "capabilities": ["Comic-Con", "Jashan-e-Rekhta", "Ziro Festival", "Bir Music Festival", "TEDx circuits"], "featured": False, "publicStatus": "public", "lastVerified": "2025-Q3", "portfolioUrl": None, "note": "Festival partnership access for brand moments."},
    {"name": "Campus Network", "slug": "campus-network", "category": "Events", "relationshipType": "NETWORK ACCESS", "geography": "India", "capabilities": ["NIFT Delhi", "Delhi University", "IIT Delhi", "IIT Bombay", "Symbiosis Pune", "St. Xavier's"], "featured": False, "publicStatus": "public", "lastVerified": "2025-Q3", "portfolioUrl": None, "note": "Institutional access for campus activations."},
]
...
INSIGHTS = [
    ...
    },
    {
        ...
        "body": [
            {"type": "p", "text": "Ask a branding agency what your business needs and the answer will involve branding. Ask a performance agency and the answer will involve media spend. Ask a development studio and — you can see where this is going. Nobody is lying. Everybody is selling."},
...
PORTFOLIO_GROUPS = [
    {"category": "Brand Decks", "slug": "brand-decks", "items": ["Orange Owl", "Orange Curry", "Creative Whoop", "Better Together America", "Anandam"]},
    {"category": "Packaging", "slug": "packaging", "items": ["Danbro", "Foilking", "Astronut", "Mr Brown", "Stir Branding", "Tranquilli Tea"]},
    {"category": "Web Development", "slug": "web-development", "items": ["Ashok Leyland", "Usual Designer Gifts", "Daily Life Prime", "Primo Customs", "Tasavur", "DGbog", "Ekdanta Taxi", "Cure It Herb", "Mall of Tastes"]},
    {"category": "E-Commerce", "slug": "e-commerce", "items": ["Auto Parts Sooq", "Asha Cart", "Havora Store", "Mud Patch (commerce + design)"]},
    {"category": "Motion Graphics", "slug": "motion-graphics", "items": ["Samsung Teams", "Vesta", "Kotak Mutual Funds", "T20 World Cup x OREO (2D)"]},
    {"category": "Audio Production", "slug": "audio-production", "items": ["Hitachi", "CliniExpert", "Handloom Ministry anthem - shared by the PM's office", "Filter Coffee x Dice Media"]},
    {"category": "Social Media", "slug": "social-media", "items": ["Vimeo x OPPO Kolkata", "OPPO", "Realme Philippines", "Urban Company", "Ajio", "Embassy of India - France & Monaco", "Koovs", "Joseph Radhik", "City Cart", "Hyundai India", "52nd International Film Festival, Goa", "Mini India", "Whiteland Corporation", "Hippo Homes", "Organic India", "Hero MotoCorp", "Surya Roshni", "Cheesecake & Co.", "Maharaja Whiteline", "Soulflower", "Bath & Body Works", "Hamdard", "PhonePe", "Tecno Mobile", "Canon India"]},
    {"category": "TVC & Video Production", "slug": "tvc-video-production", "items": ["BharatPe", "Armstrong Tires", "Australian Avocados", "Jotun Paints Arabia"]},
]
