...
export const DISCIPLINES = [
  {
    ...
    body: [
      ...
      "We start by mapping what is actually happening — the numbers, the workflow, the customer's real route through your business — then name the one or two constraints everything else is bending around. Fix the constraint and a surprising amount of the backlog quietly stops mattering.",
    ],
    signals: [
  ...
  },
  {
    ...
    body: [
      "We match by fit rather than follower count — singers, comedians, sketch artists, podcasters, vloggers, voice artists — and brief them properly, which mostly means telling them what is true and letting them say it their way.",
