...
export default function Resources() {
  ...
  return (
    <div ref={ref} className="pt-[68px]" data-testid="resources-page">
          ...
          {RESOURCES.map((r, i) => (
            <Reveal key={r.t} delay={i * 90}>
              <div className="cap-tile panel-paper flex h-full flex-col p-7" data-testid={`resource-card-${i}`}>
                ...
                <p className="mt-3 flex-1 text-[14px] leading-relaxed text-[#232A2A]/78">{r.b}</p>
        ...
        <div className="mt-16 grid gap-8 lg:grid-cols-2">
          <Reveal>
            <section id="privacy" className="panel-paper p-7 sm:p-9" data-testid="resources-privacy">
              ...
              <p className="mt-4 text-[14px] leading-relaxed text-[#232A2A]/78">
