...
export default function HowWeWork() {
  ...
  return (
    <div ref={ref} className="pt-[84px]" data-testid="how-we-work-page">
      <Seo title="How We Work | Five Stages, One Method | hiAnzy" description="The hiAnzy operating model: Audit, Architect, Build, Connect, Scale. Less ceremony. More consequence." />
